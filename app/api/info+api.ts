...
export async function GET(request: Request) {
  ...
  //     const idsIndex = p?.findIndex((val) => val === 'ids');
  //     ids = p[idsIndex + 1];
  //   }
...
const data = {
  '1': {
    ...
    category: 'coin',
    description:
      'Bitcoin (BTC) is a cryptocurrency launched in 2010. Users are able to generate BTC through the process of mining. Bitcoin has a current supply of 19,705,575. The last known price of Bitcoin is 68,503.95657901 USD and is up 1.09 over the last 24 hours. It is currently trading on 11078 active market(s) with $27,130,294,086.23 traded over the last 24 hours. More information can be found at https://bitcoin.org/.',
    slug: 'bitcoin',
  ...
  '825': {
    ...
    category: 'token',
    description:
      'Tether USDt (USDT) is a cryptocurrency and operates on the Ethereum platform. Tether USDt has a current supply of 115,086,550,409.00151 with 111,963,763,434.50261 in circulation. The last known price of Tether USDt is 0.99957403 USD and is up 0.03 over the last 24 hours. It is currently trading on 87298 active market(s) with $63,622,207,352.76 traded over the last 24 hours. More information can be found at https://tether.to.',
    slug: 'tether',
  ...
  '1027': {
    ...
    category: 'coin',
    description:
      'Ethereum (ETH) is a cryptocurrency . Ethereum has a current supply of 120,139,697.95266497. The last known price of Ethereum is 3,775.8042152 USD and is down -0.21 over the last 24 hours. It is currently trading on 9014 active market(s) with $15,882,293,715.13 traded over the last 24 hours. More information can be found at https://www.ethereum.org/.',
    slug: 'ethereum',
  ...
  '1839': {
    ...
    category: 'coin',
    description:
      'BNB (BNB) is a cryptocurrency . BNB has a current supply of 147,585,418.2426454. The last known price of BNB is 596.04870944 USD and is down -0.16 over the last 24 hours. It is currently trading on 2172 active market(s) with $1,785,214,662.29 traded over the last 24 hours. More information can be found at https://bnbchain.org/en.',
    slug: 'bnb',
  ...
  '5426': {
    ...
    category: 'coin',
    description:
      'Solana (SOL) is a cryptocurrency launched in 2020. Solana has a current supply of 577,101,709.5086418 with 459,619,897.3012483 in circulation. The last known price of Solana is 168.76130417 USD and is down -0.04 over the last 24 hours. It is currently trading on 668 active market(s) with $2,789,196,317.33 traded over the last 24 hours. More information can be found at https://solana.com.',
    slug: 'solana',
    ...
    urls: {
      ...
      explorer: [
        ...
        'https://www.okx.com/web3/explorer/sol',
      ],
